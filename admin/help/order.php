...
<ul>
    ...
    <li><b>catalog_show_all_goods</b> – показывать все товары одним списком (0-выключено, 1-включено)</li>	
</ul>
<p>Для передачи, добавьте необходимые вам параметры в тело шоткода:</p>
<ul>
	<li>[awo_catalog_of_goods catalog_goods_per_page=“12” catalog_show_all_goods=“1” catalog_settings_submit_value=“Добавить в корзину”]</li>
</ul>
...
<h3>Вывод цены товара на странице описания</h3>
<p>Для вывода цены товара, вам необходимо использовать шоткод:</p>
<ul>
	<li><b>[awo_goods_price id_goods=“1”]</b> – «Цена товара»</li>
</ul>
<p>Шоткод [awo_goods_price] имеет обязательный параметр:</p>
<ul>
	<li><b>id_goods *</b> – код товара (ОБЯЗАТЕЛЬНЫЙ параметр)</li>
</ul>
